    ...
    <div>
      ...
      <div className='lg:w-10/12 lg:p-0 px-2 mx-auto'>
        ...
        <div className='flex justify-center items-center mt-4'>
          ...
          <div id='spinner4' className='hidden ml-4' role="status">
            <svg aria-hidden="true" class="w-6 h-6 text-center text-gray-200 animate-spin dark:text-gray-600 fill-blue-700" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
